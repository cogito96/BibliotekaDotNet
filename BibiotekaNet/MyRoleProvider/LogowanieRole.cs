...
namespace BibiotekaNet.MyRoleProvider
{
    public class LogowanieRole : RoleProvider
    {
        ...
        public override string[] GetRolesForUser(string login)
        {
            ...
            //var pracownik = db.Pracownicy.Where(x => x.LoginPracownika == login).FirstOrDefault();
            //if (pracownik != null)
            //{
